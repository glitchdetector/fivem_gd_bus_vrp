...
--[[
 animations = 
{
{"ANIM@AMB@OFFICE@BOARDROOM@CREW@FEMALE@VAR_A@BASE@"}, {"ANIM@AMB@OFFICE@BOARDROOM@CREW@MALE@VAR_A@BASE@"}, {"ANIM@AMB@OFFICE@BOARDROOM@CREW@FEMALE@VAR_b@BASE@"}, {"ANIM@AMB@OFFICE@BOARDROOM@CREW@MALE@VAR_b@BASE@"}, {"ANIM@AMB@OFFICE@BOARDROOM@CREW@FEMALE@VAR_C@BASE@"}, 
{"ANIM@AMB@OFFICE@BOARDROOM@CREW@MALE@VAR_C@BASE@"}, 
{"ANIM@AMB@CLUBHOUSE@BOARDROOM@BOSS@FEMALE@BASE@"}, 
{"ANIM@AMB@CLUBHOUSE@BOARDROOM@BOSS@MALE@BASE@"}, 
{"anim@AMB@OFFICE@LAPTOPS@FEMALE@VAR_A@BASE@", "IDLE_A"}, 
{"anim@AMB@OFFICE@LAPTOPS@FEMALE@VAR_A@BASE@", "IDLE_B"}, 
{"anim@AMB@OFFICE@LAPTOPS@FEMALE@VAR_A@BASE@", "IDLE_C"}
{"anim@AMB@OFFICE@LAPTOPS@FEMALE@VAR_A@BASE@", "BASE"}, 
}
--]]
...
---------------------------(camera stuff)------------------------------
	...
	RenderScriptCams(true, 0, 1000, 1, 0, 0)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
                    if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1), true), 888.4329, -3206.185, -99.1861) < 1.8 then -- INPUT_CELLPHONE_DOWN
                        Main() -- Menu to draw
                        Menu.hidden = false
					else 
					    menu.hidden = true
